...
/*   Updated: 2022/04/15 12:13:57 by susami           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	ASSERT_EQ_I(ft_atoi(""), atoi(""));
	ASSERT_EQ_I(ft_atoi("-"), atoi("-"));
	ASSERT_EQ_I(ft_atoi("+"), atoi("+"));
	ASSERT_EQ_I(ft_atoi("0"), atoi("0"));
	ASSERT_EQ_I(ft_atoi("-0"), atoi("-0"));
	ASSERT_EQ_I(ft_atoi("+0"), atoi("+0"));
	ASSERT_EQ_I(ft_atoi("1"), atoi("1"));
	ASSERT_EQ_I(ft_atoi("-1"), atoi("-1"));
	ASSERT_EQ_I(ft_atoi("+1"), atoi("+1"));
	ASSERT_EQ_I(ft_atoi("7"), atoi("7"));
	ASSERT_EQ_I(ft_atoi("-7"), atoi("-7"));
	ASSERT_EQ_I(ft_atoi("+7"), atoi("+7"));
	ASSERT_EQ_I(ft_atoi("42"), atoi("42"));
	ASSERT_EQ_I(ft_atoi("-42"), atoi("-42"));
	ASSERT_EQ_I(ft_atoi("a"), atoi("a"));
	ASSERT_EQ_I(ft_atoi("!"), atoi("!"));
	/* INT_MAX */ ASSERT_EQ_I(ft_atoi("2147483647"), atoi("2147483647"));
	/* INT_MIN */ ASSERT_EQ_I(ft_atoi("-2147483648"), atoi("-2147483648"));
	/* UINT_MAX */ ASSERT_EQ_I(ft_atoi("4294967295"), atoi("4294967295"));
	/* LONG_MAX */ ASSERT_EQ_I(ft_atoi("9223372036854775807"), atoi("9223372036854775807"));
	/* LONG_MIN */ ASSERT_EQ_I(ft_atoi("-9223372036854775808"), atoi("-9223372036854775808"));
	/* ULONG_MAX */ ASSERT_EQ_I(ft_atoi("18446744073709551615"), atoi("18446744073709551615"));
	/* SIZE_MAX */ ASSERT_EQ_I(ft_atoi("18446744073709551615"), atoi("18446744073709551615"));
